...
<body>
    ...
    <div class="container">
        <div class="row">
           ...
           <h3 class="h3" style="font-size: 24px;cursor: pointer;position: fixed;bottom: 32px;right: 20px;font-weight: bold;"><a href="http://localhost/shoppers%20paradigm/shirts.php" target="_self">Clear Filters</a></h3>
        </div>
